namespace GLC.Integration.Cargowiseone.StyleOne {
    ...
    public sealed class TransformUniversalshipmenttoInterchangestyleone : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        ...
        <ns0:Acknowledgement>
          ...
          <ns0:ContextCollection>
            <ns0:Context>
              ...
              <ns0:Value>CLABRD</ns0:Value>
            </ns0:Context>
            <ns0:Context>
              <ns0:Type>MESSAGE_IDENTIFIER</ns0:Type>
              <ns0:Value>CLABRAUS_EDI940</ns0:Value>
            </ns0:Context>
            <ns0:Context>
